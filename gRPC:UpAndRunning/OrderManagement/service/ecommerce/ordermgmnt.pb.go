...
func (x *Order) Reset() {
	*x = Order{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ordermgmnt_proto_msgTypes[0]
...
func (*Order) Descriptor() ([]byte, []int) {
	return file_ordermgmnt_proto_rawDescGZIP(), []int{0}
}
...
var File_ordermgmnt_proto protoreflect.FileDescriptor

var file_ordermgmnt_proto_rawDesc = []byte{
	0x0a, 0x10, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x6d, 0x67, 0x6d, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x8e, 0x01, 0x0a, 0x0f, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x3a, 0x0a, 0x08, 0x67,
	...
	0x65, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x3f, 0x0a, 0x0b, 0x73, 0x65, 0x61, 0x72, 0x63,
	0x68, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
...
var (
	file_ordermgmnt_proto_rawDescOnce sync.Once
	file_ordermgmnt_proto_rawDescData = file_ordermgmnt_proto_rawDesc
)

func file_ordermgmnt_proto_rawDescGZIP() []byte {
	file_ordermgmnt_proto_rawDescOnce.Do(func() {
		file_ordermgmnt_proto_rawDescData = protoimpl.X.CompressGZIP(file_ordermgmnt_proto_rawDescData)
	})
	return file_ordermgmnt_proto_rawDescData
}

var file_ordermgmnt_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ordermgmnt_proto_goTypes = []interface{}{
	(*Order)(nil),                // 0: ecommerce.Order
	(*wrappers.StringValue)(nil), // 1: google.protobuf.StringValue
}
var file_ordermgmnt_proto_depIdxs = []int32{
	1, // 0: ecommerce.OrderManagement.getOrder:input_type -> google.protobuf.StringValue
	1, // 1: ecommerce.OrderManagement.searchOrder:input_type -> google.protobuf.StringValue
	0, // 2: ecommerce.OrderManagement.getOrder:output_type -> ecommerce.Order
	0, // 3: ecommerce.OrderManagement.searchOrder:output_type -> ecommerce.Order
...
func init() { file_ordermgmnt_proto_init() }
func file_ordermgmnt_proto_init() {
	if File_ordermgmnt_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ordermgmnt_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Order); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ordermgmnt_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_ordermgmnt_proto_goTypes,
		DependencyIndexes: file_ordermgmnt_proto_depIdxs,
		MessageInfos:      file_ordermgmnt_proto_msgTypes,
	}.Build()
	File_ordermgmnt_proto = out.File
	file_ordermgmnt_proto_rawDesc = nil
	file_ordermgmnt_proto_goTypes = nil
	file_ordermgmnt_proto_depIdxs = nil
}
...
func (c *orderManagementClient) SearchOrder(ctx context.Context, in *wrappers.StringValue, opts ...grpc.CallOption) (OrderManagement_SearchOrderClient, error) {
	stream, err := c.cc.NewStream(ctx, &_OrderManagement_serviceDesc.Streams[0], "/ecommerce.OrderManagement/searchOrder", opts...)
	if err != nil {
		return nil, err
	}
